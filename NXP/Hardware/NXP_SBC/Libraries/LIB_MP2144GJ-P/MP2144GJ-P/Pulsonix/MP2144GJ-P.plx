...
//537879/1036079/2.50/8/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "MP2144GJ-P" (originalName "MP2144GJ-P")
	...
	(compDef "MP2144GJ-P" (originalName "MP2144GJ-P") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		)
		...
		(compPin "6" (pinName "AGND") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "MP2144GJ-P"))
		...
		(attr "Mouser Part Number" "946-MP2144GJP")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Monolithic-Power-Systems-MPS/MP2144GJ-P?qs=Iq7RKQRjpgoW7cEm9TP09w%3D%3D")
		(attr "Manufacturer_Name" "Monolithic Power Systems (MPS)")
		(attr "Manufacturer_Part_Number" "MP2144GJ-P")
		(attr "Description" "Monolithic Power Systems (MPS), MP2144GJ-P Step-Down Switching Regulator 2A Adjustable, Minimum of 0.6 V, 8-Pin TSOT-23")
		(attr "<Hyperlink>" "http://www.monolithicpower.com/DesktopModules/DocumentManage/API/Document/GetDocument?id=522")
		(attr "<Component Height>" "1")
		(attr "<STEP Filename>" "MP2144GJ-P.stp")
